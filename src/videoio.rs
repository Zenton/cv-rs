...
extern "C" {
    ...
    pub fn cv_videocapture_from_file(path: *const c_char) -> *mut CVideoCapture;
    pub fn cv_videocapture_from_gst_pipeline(pipeline: *const c_char) -> *mut CVideoCapture;
    pub fn cv_videocapture_is_opened(ccap: *const CVideoCapture) -> bool;
    pub fn cv_videocapture_read(v: *mut CVideoCapture, m: *mut CMat) -> bool;
    pub fn cv_videocapture_drop(cap: *mut CVideoCapture);
    pub fn cv_videocapture_set(cap: *mut CVideoCapture, property: CapProp, value: c_double) -> bool;
    pub fn cv_videocapture_get(cap: *mut CVideoCapture, property: CapProp) -> c_double;
}

/// Video capturing from video files, image sequences or cameras.
#[derive(Debug)]
pub struct VideoCapture {
    pub inner: *mut CVideoCapture,
}
